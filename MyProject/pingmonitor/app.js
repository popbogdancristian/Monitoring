	...
	function RunThePings(){
	    ...
	    // This just continuously runs the function every 30000 miliseconds (1 minute).
		setTimeout(RunThePings, 30000);
	}
	...
	app.get('/', function (req, res) {
		res.sendFile('/home/zog/pingmonitor/index.html');
	});

	// We then tell the app which port to listen on.
	app.listen(2525, function (){
		console.log('listen on port 2525'); // locahost:2525/
	});
